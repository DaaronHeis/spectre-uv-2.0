...
class AstroSensor:
    ...
    """
    def __init__(self, L_meas, w_cor, ERROR_KEY: bool):
    ...
    def set_current_orientation(self, L):
        """
    ...
    def set_correction(self, L_from_CU):
        """
...
class ControlUnit:
    ...
    def get_correction(self, astrosensor):
        ...
        self.omega_cor = astrosensor.get_correction(self.L_cur)
